      ...
      <section className="relative min-h-screen flex items-center justify-center text-center overflow-hidden bg-gradient-to-br from-[#0a1e27] via-[#1A3A4A] to-[#0d4c65]">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 py-20">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button asChild size="lg" className="bg-[#29B9E8] hover:bg-[#1A9FC8] text-white font-bold rounded-full px-8 gap-2 text-base">
              <Link href="/shop">Voir le catalogue <ChevronRight size={18} /></Link>
            </Button>
            <Button asChild size="lg" variant="outline"
              className="border-white/30 text-white hover:bg-white/10 hover:text-white rounded-full px-8 gap-2 text-base bg-transparent">
      ...
      <section className="py-24 bg-gray-50 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mt-10">
            <Button asChild size="lg" className="bg-[#1A3A4A] hover:bg-[#29B9E8] text-white font-bold rounded-full px-10">
